...
Use this as the Codex project-skill entry point.

1. Locate the repository root containing `AGENTS.md`.
2. Read `.claude/skills/report-to-infographic-toon/SKILL.md` completely and follow it as the canonical workflow.
3. Resolve its `references/source-report-guide.md` link relative to `.claude/skills/report-to-infographic-toon/`.
4. Do not duplicate or independently reinterpret the canonical workflow. Preserve one source of truth for Codex and Claude Code.
